...
PROJECT = {
  "code": "R-08",
  "slug": "connection-quality-monitor",
  "title": "Monitor De Qualidade De Conexao",
  "kind": "connection_quality",
  "description": "Mede disponibilidade, latencia e qualidade de conexao em modo sintetico por padrao."
}
